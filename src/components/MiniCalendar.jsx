              ...
              {hasPurchases ? (
                ...
                `}>
                  ...
                  {dayPurchases.length > 1 && (
                    <span className="absolute -top-0.5 -right-0.5 bg-white dark:bg-gray-200 text-gray-800 dark:text-gray-900 text-[8px] font-bold px-1 min-w-[14px] text-center rounded-full shadow-md border border-gray-200 dark:border-gray-300">
                      {dayPurchases.length}
                    </span>
                  )}
                </div>
